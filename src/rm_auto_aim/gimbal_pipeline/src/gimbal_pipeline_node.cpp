...
: Node("gimbal_pipeline", options) {
  ...
  double prediction_delay = get_parameter("controller.delay.prediction_extra_s").as_double();
  ...
  double controller_delay = get_parameter("controller.delay.control_latency_s").as_double();
  double trigger_to_muzzle_s = get_parameter("controller.delay.trigger_to_muzzle_s").as_double();
  double max_processing_delay_s =
    get_parameter("controller.delay.max_processing_delay_s").as_double();
  std::string selection_method_str =
  ...
  int fire_flight_time_iters = get_parameter("controller.delay.flight_time_iters").as_int();
