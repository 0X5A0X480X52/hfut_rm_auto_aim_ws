...
OutpostBaselineBindingPolicy::OutpostBaselineBindingPolicy(
...
OutpostBaselineBindingOutput OutpostBaselineBindingPolicy::step(
    const OutpostBaselineBindingInput & input) {
  if (input.obs == nullptr) {
    const auto fsm_out = binding_fsm_.output();
    OutpostBaselineBindingOutput out;
...
void OutpostBaselineBindingPolicy::apply_directional_topology_prior(
...
OutpostBaselineBindingOutput OutpostBaselineBindingPolicy::build_output(
