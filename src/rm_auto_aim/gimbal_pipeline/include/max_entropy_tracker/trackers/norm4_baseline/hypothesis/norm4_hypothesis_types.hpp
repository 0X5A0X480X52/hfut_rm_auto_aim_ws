...
#ifndef MAX_ENTROPY_TRACKER_TRACKERS_NORM4_BASELINE_NORM4_HYPOTHESIS_TYPES_HPP_
#define MAX_ENTROPY_TRACKER_TRACKERS_NORM4_BASELINE_NORM4_HYPOTHESIS_TYPES_HPP_
...
enum class Norm4BaselineMode { AMBIGUOUS = 0, STRUCTURED = 1 };
...
struct BaselineDebugSnapshot {
  ...
  // Baseline TopK and hypothesis debug
  bool committed = false;
  double top1_confidence = 0.0;
  double top1_top2_margin = 0.0;
  double top1_nis = -1.0;
...
#endif  // MAX_ENTROPY_TRACKER_TRACKERS_NORM4_BASELINE_NORM4_HYPOTHESIS_TYPES_HPP_
