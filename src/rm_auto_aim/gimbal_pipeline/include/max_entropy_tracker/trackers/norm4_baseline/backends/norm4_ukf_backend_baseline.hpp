...
#ifndef MAX_ENTROPY_TRACKER_TRACKERS_NORM4_BASELINE_NORM4_UKF_BACKEND_BASELINE_HPP_
#define MAX_ENTROPY_TRACKER_TRACKERS_NORM4_BASELINE_NORM4_UKF_BACKEND_BASELINE_HPP_
...
class Norm4UkfBackendBaseline : public SpinFilterInterface {
 public:
  explicit Norm4UkfBackendBaseline(const UnifiedConfig &config, double dt = 0.05);
...
#endif  // MAX_ENTROPY_TRACKER_TRACKERS_NORM4_BASELINE_NORM4_UKF_BACKEND_BASELINE_HPP_
