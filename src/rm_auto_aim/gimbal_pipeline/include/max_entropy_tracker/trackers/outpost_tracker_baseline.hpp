...
#ifndef MAX_ENTROPY_TRACKER_TRACKERS_OUTPOST_TRACKER_BASELINE_HPP_
#define MAX_ENTROPY_TRACKER_TRACKERS_OUTPOST_TRACKER_BASELINE_HPP_
...
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_ambiguous_backend.hpp"
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_binder_bridge.hpp"
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_observation_frontend.hpp"
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_output_adapter.hpp"
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_runtime_context.hpp"
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_structured_backend.hpp"
#include "max_entropy_tracker/utils/maneuver_detector.hpp"

namespace fyt::auto_aim {

class OutpostTrackerBaseline : public BaseTracker {
 public:
  ...
  explicit OutpostTrackerBaseline(const UnifiedConfig &config, double dt = 0.05,
 ...
 private:
  ...
  void sync_runtime_from_backend(const outpost_baseline::BackendStateSnapshot &snap);
  void reset_warmup();
  ...
  void refresh_debug(const ObservationData *obs,
                     const outpost_baseline::BindingCandidate &candidate,
  ...
  outpost_baseline::ObservationFrontend obs_frontend_;
  outpost_baseline::OutpostBinderBridge binder_bridge_;
  mode::EvidenceFuser evidence_fuser_;
  mode::ModeFSM mode_fsm_;
  outpost_baseline::OutpostAmbiguousBackend ambiguous_backend_;
  outpost_baseline::OutpostStructuredBackend structured_backend_;
  outpost_baseline::OutpostOutputAdapter output_adapter_;
  ManeuverDetector maneuver_detector_;

  outpost_baseline::OutpostRuntimeContext ctx_;
...
#endif  // MAX_ENTROPY_TRACKER_TRACKERS_OUTPOST_TRACKER_BASELINE_HPP_
