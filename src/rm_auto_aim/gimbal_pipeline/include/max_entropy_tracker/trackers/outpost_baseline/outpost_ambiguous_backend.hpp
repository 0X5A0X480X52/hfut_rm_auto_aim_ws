...
#ifndef MAX_ENTROPY_TRACKER_TRACKERS_OUTPOST_BASELINE_OUTPOST_AMBIGUOUS_BACKEND_HPP_
#define MAX_ENTROPY_TRACKER_TRACKERS_OUTPOST_BASELINE_OUTPOST_AMBIGUOUS_BACKEND_HPP_
...
#include "max_entropy_tracker/trackers/outpost_baseline/outpost_backend_interface.hpp"
...
class OutpostAmbiguousBackend : public IOutpostBackend {
 ...
 private:
  ...
  // Routes to the baseline KF or IMM core depending on config.
...
#endif  // MAX_ENTROPY_TRACKER_TRACKERS_OUTPOST_BASELINE_OUTPOST_AMBIGUOUS_BACKEND_HPP_
