...
#ifndef SERIAL_DRIVER_INFANTRY_PROTOCOL_BLIND_HPP_
#define SERIAL_DRIVER_INFANTRY_PROTOCOL_BLIND_HPP_

#include "rm_serial_driver/protocol.hpp"

namespace fyt::serial_driver::protocol {
// 步兵通信协议
class ProtocolInfantryBlind : public Protocol {
public:
  explicit ProtocolInfantryBlind(std::string_view port_name, bool enable_data_print);

  ~ProtocolInfantryBlind() = default;
...
#endif  // SERIAL_DRIVER_INFANTRY_PROTOCOL_BLIND_HPP_
